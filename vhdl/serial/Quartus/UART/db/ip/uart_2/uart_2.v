...
module uart_2 (
		...
		input  wire        hps_uart_cts,       // hps_uart.cts
		input  wire        hps_uart_dsr,       //         .dsr
		input  wire        hps_uart_dcd,       //         .dcd
		input  wire        hps_uart_ri,        //         .ri
		output wire        hps_uart_dtr,       //         .dtr
		output wire        hps_uart_rts,       //         .rts
		output wire        hps_uart_out1_n,    //         .out1_n
		output wire        hps_uart_out2_n,    //         .out2_n
		input  wire        hps_uart_rxd,       //         .rxd
		output wire        hps_uart_txd,       //         .txd
